...
├── css/style.css         дизайн-система + все стили
├── js/main.js            интро, частицы, курсор, меню, кейсы, форма
├── assets/
...
- **Подключить отправку формы** — инструкция прямо в коде: `js/main.js`, функция `initForm`.
