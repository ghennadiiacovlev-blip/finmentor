...
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#e8e5df;color:var(--ink);font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;line-height:1.58}button,input,textarea,select{font:inherit}a{color:inherit}.topbar{height:54px;background:var(--navy);color:#f5efe1;display:flex;align-items:center;justify-content:space-between;padding:0 30px;letter-spacing:.04em}.brand{font-family:Georgia,serif;font-weight:700;letter-spacing:.14em}.topstate{font-size:12px;color:var(--gold2);text-transform:uppercase}.paper{max-width:1160px;margin:26px auto 70px;background:var(--paper);box-shadow:var(--shadow);min-height:900px}.hero{background:var(--navy);color:#fff;padding:46px 58px 42px;border-top:3px solid var(--gold)}.eyebrow,.section-no,.kind,.micro,.edit-field>span,.path-step{font-size:11px;font-weight:800;letter-spacing:.16em;text-transform:uppercase}.eyebrow{color:var(--gold2)}h1{font-family:Georgia,"Times New Roman",serif;font-size:46px;line-height:1.04;margin:13px 0 9px;font-weight:600}.identity{font-size:18px;color:#e1ded6;margin:0}.hero-layout{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(260px,.65fr);gap:42px;align-items:end}.hero-context{margin:13px 0 0;color:#b8c0c9;font-size:14px}.secondary-line{margin-top:18px;color:#9da9b7;font-size:12px;letter-spacing:.03em}.contact-card{border-top:1px solid rgba(214,196,156,.55);padding-top:17px}.contact-card .micro{color:var(--gold2)}.contact-card strong{display:block;font-family:Georgia,serif;font-size:20px;font-weight:500;margin:5px 0}.contact-card p{margin:4px 0;color:#dce1e5;font-size:13px}.warn{color:#e0b87a!important}.hero-priority{display:grid;grid-template-columns:1fr 1.2fr 1fr;gap:0;margin-top:34px;border:1px solid rgba(214,196,156,.3)}.hero-signal{padding:20px 22px;border-right:1px solid rgba(214,196,156,.25)}.hero-signal:last-child{border-right:0}.hero-signal .micro{color:#aeb7c2}.hero-signal strong{display:block;margin-top:7px;font-size:15px;line-height:1.45}.executive-path{max-width:980px;margin:0 auto;padding:40px 54px 10px;display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.path-card{background:var(--white);padding:20px 21px 22px;border-top:2px solid var(--gold);min-height:150px}.path-step{color:var(--gold)}.path-card h2{font-family:Georgia,serif;font-size:18px;line-height:1.2;margin:9px 0 8px;font-weight:600}.path-card p{font-size:13px;line-height:1.48;margin:0;color:#465363}.memo{max-width:850px;margin:0 auto;padding:38px 54px 70px}.section{display:grid;grid-template-columns:74px 1fr;gap:18px;padding:37px 0;border-top:1px solid var(--line)}.section:first-child{padding-top:12px}.section-no{color:var(--gold);padding-top:8px}.section h2{font-family:Georgia,serif;font-size:27px;line-height:1.2;margin:0 0 21px;font-weight:600}.kind{display:inline-block;margin-bottom:8px}.kind.fact{color:var(--fact)}.kind.interpretation{color:var(--gold)}.kind.verify{color:var(--verify)}.fact-row{padding:0 0 18px;margin:0 0 18px;border-bottom:1px solid #e5ded2}.fact-row:last-child{border:0;margin-bottom:0}.fact-row h3,.diagnosis h3,.pain h3{font-size:13px;margin:0 0 6px;color:#53606e}.fact-row p,.diagnosis p,.pain p{margin:0;font-size:16px}.diagnosis{padding:0 0 23px;margin:0 0 23px;border-bottom:1px solid #e5ded2}.diagnosis:last-child{border:0}.evidence{margin-top:9px!important;font-size:12px!important;color:var(--muted)}.hypothesis{margin-top:9px!important;color:#39495c}.pain-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.pain{background:var(--white);padding:22px;border-left:2px solid var(--gold)}.pain .attention{font-size:11px;text-transform:uppercase;letter-spacing:.12em;color:var(--verify);margin-bottom:11px}.why{color:var(--muted);font-size:14px!important;margin-top:9px!important}.unknown{display:grid;grid-template-columns:24px 1fr;gap:12px;margin:0 0 18px}.unknown .mark{font-family:Georgia,serif;color:var(--verify);font-size:20px}.unknown strong{display:block;font-size:15px}.unknown p{margin:3px 0 0;color:var(--muted);font-size:14px}.statement{font-family:Georgia,serif;font-size:23px;line-height:1.45;border-left:3px solid var(--gold);padding:6px 0 6px 22px;margin:0}.opening{background:var(--navy2);color:#fbf7ed;padding:28px 30px;font-family:Georgia,serif;font-size:21px;line-height:1.5}.question{display:grid;grid-template-columns:33px 1fr;gap:14px;padding:0 0 21px;margin-bottom:21px;border-bottom:1px solid var(--line)}.question:last-child{border:0}.qno{font-family:Georgia,serif;color:var(--gold);font-size:19px}.question strong{display:block;font-size:16px}.question p{margin:7px 0 0;color:var(--muted);font-size:13px}.solution{background:#eee8dc;padding:27px 29px}.solution-row{margin:0 0 19px}.solution-row:last-child{margin:0}.solution-row .micro{color:#7c6a48}.solution-row p{margin:5px 0 0}.conditions{margin:6px 0 0;padding-left:19px}.decision{display:grid;grid-template-columns:1fr 1fr;gap:23px}.decision>div{padding-top:14px;border-top:2px solid var(--gold)}.decision p{margin:5px 0;color:var(--muted)}.owner-note{background:#e9ede8;border-left:3px solid var(--ok);padding:17px 20px;margin-bottom:12px}.owner-note p{margin:4px 0}.details{border-top:1px solid var(--line);padding:18px 0}.details summary{cursor:pointer;font-weight:700;list-style:none;display:flex;justify-content:space-between}.details summary:after{content:"+";color:var(--gold);font-size:20px}.details[open] summary:after{content:"−"}.details-body{padding:17px 0;color:var(--muted)}.actionsbar{position:sticky;bottom:0;background:rgba(247,243,235,.97);backdrop-filter:blur(10px);border-top:1px solid var(--line);display:flex;gap:10px;justify-content:flex-end;padding:14px 26px;z-index:8}.btn{display:inline-block;border:1px solid var(--navy);background:transparent;color:var(--navy);padding:10px 17px;text-decoration:none;font-weight:700;cursor:pointer;text-align:center}.btn.primary{background:var(--navy);color:#fff}.btn.gold{background:var(--gold);border-color:var(--gold);color:#fff}.btn.ghost{border-color:transparent}.action-overflow{position:relative}.action-overflow summary{list-style:none}.action-overflow summary::-webkit-details-marker{display:none}.action-menu{position:absolute;right:0;bottom:50px;width:260px;background:var(--white);border:1px solid var(--line);box-shadow:0 14px 36px rgba(8,20,36,.18);padding:8px}.action-menu .btn{display:block;width:100%;border:0;text-align:left}.capture,.editor,.preview{background:var(--white);padding:32px;margin:20px 0}.capture h2,.editor h2,.preview h2{font-family:Georgia,serif;font-size:26px;margin-top:0}.choice-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-bottom:24px}.choice{display:flex;gap:9px;align-items:flex-start;border:1px solid var(--line);padding:12px;background:#fff}.choice input{margin-top:5px}.edit-field{display:block;margin:0 0 18px}.edit-field>span{display:block;color:#5b6672;margin-bottom:7px}.edit-field textarea,.edit-field input,.edit-field select,select{width:100%;border:1px solid #cfc6b7;background:#fffdf8;padding:11px 12px;color:var(--ink)}.edit-field small{display:block;color:var(--muted);margin-top:4px}.form-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:22px}.client-sheet{background:white;max-width:690px;margin:0 auto;padding:44px;box-shadow:0 12px 35px rgba(10,20,30,.09)}.client-sheet .client-brand{color:var(--gold);letter-spacing:.15em;font-size:12px;font-weight:800}.client-sheet h2{font-family:Georgia,serif;font-size:32px;margin:8px 0}.client-score{font-size:13px;color:var(--muted);border-bottom:1px solid var(--line);padding-bottom:20px}.client-sheet h3{font-family:Georgia,serif;margin:27px 0 10px}.client-sheet p,.client-sheet li{font-size:15px}.client-risk{padding:15px 0;border-bottom:1px solid #eee}.contact-panel{background:var(--white);padding:30px}.contact-route{display:grid;grid-template-columns:110px 1fr;gap:12px;padding:10px 0;border-bottom:1px solid var(--line)}.contact-route span{color:var(--muted)}.empty{color:var(--muted);font-style:italic}.screen-note{text-align:center;color:var(--muted);padding:50px}.toast{max-width:720px;margin:40px auto;background:var(--white);padding:30px;border-top:3px solid var(--gold)}
@media(max-width:760px){.topbar{height:48px;padding:0 16px}.topstate{font-size:10px}.paper{margin:0;box-shadow:none}.hero{padding:29px 20px 25px}.hero-layout{display:block}.hero h1{font-size:35px}.identity{font-size:16px}.hero-context{font-size:13px}.secondary-line{font-size:11px;margin-top:13px}.contact-card{margin-top:22px}.contact-card strong{font-size:18px}.hero-priority{grid-template-columns:1fr;margin-top:24px}.hero-signal{border-right:0;border-bottom:1px solid rgba(214,196,156,.25);padding:16px}.hero-signal:last-child{border-bottom:0}.executive-path{padding:24px 18px 6px;grid-template-columns:1fr;gap:9px}.path-card{min-height:0;padding:17px 18px}.memo{padding:24px 19px 96px}.section{display:block;padding:30px 0}.section-no{margin-bottom:8px}.section h2{font-size:24px}.pain-grid,.decision,.choice-grid{grid-template-columns:1fr}.opening{padding:23px 20px;font-size:18px}.statement{font-size:20px}.actionsbar{position:fixed;left:0;right:0;display:grid;grid-template-columns:1fr 1fr auto;padding:9px 10px;justify-content:stretch}.actionsbar>.btn{padding:11px 8px;font-size:13px}.action-overflow summary.btn{padding:11px 13px;font-size:13px}.action-menu{position:fixed;left:10px;right:10px;bottom:61px;width:auto}.capture,.editor,.preview,.contact-panel{padding:21px;margin-left:-1px;margin-right:-1px}.client-sheet{padding:26px 20px}.contact-route{grid-template-columns:1fr;gap:1px}h1{font-size:35px}}
...
function renderBriefBody(brief, row, auth) {
  ...
  const score = h.diagnostic_score == null ? 'Без оценки' : esc(h.diagnostic_score) + ' / 100 · ' + esc(zoneLabel(h.financial_zone));
  const hero = '<article class="paper"><header class="hero"><div class="hero-layout"><div><div class="eyebrow">Lead Intelligence · конфиденциально</div><h1>' + esc(h.company || 'Компания не указана') + '</h1>'
    + '<p class="identity">' + esc([h.contact_name, h.role].filter(present).join(' · ') || 'Контакт не указан') + '</p>'
    + '<p class="hero-context">' + esc([h.business,h.scale].filter(present).join(' · ') || 'Контекст бизнеса не указан') + '</p>'
    + '<p class="secondary-line">' + score + ' &nbsp;·&nbsp; ' + esc(sourceLabel(h.source)) + ' &nbsp;·&nbsp; ' + esc(h.data_quality || 'Требует проверки') + '</p></div>'
    ...
    + '<article class="path-card" data-stage="solution"><div class="path-step">05 · Решение</div><h2>Рабочая гипотеза</h2><p>' + esc(solution.format || solution.rationale || 'Сначала уточнение') + '</p></article>'
    + '<article class="path-card" data-stage="next-action"><div class="path-step">06 · Действие</div><h2>Что сделать сейчас</h2><p>' + esc(next.action || h.next_action || 'Нужно определить') + '</p></article></section>';
...
function renderOwnerBriefPage(opts) {
  ...
  let content;
  const clientEligible = brief.client_result_eligible === true;
  if (mode === 'edit' && !clientEligible) content = '<article class="paper"><main class="memo"><div class="toast"><div class="kind verify">ТОЛЬКО ДЛЯ ВЛАДЕЛЬЦА</div><h1>Клиентский результат не предусмотрен</h1><p>Исходный путь не содержал явного запроса или обещания клиентского разбора.</p></div></main></article>';
  else if (mode === 'edit') content = '<article class="paper"><main class="memo">' + renderEditor(o.client_draft, auth) + '</main></article>';
  else if (mode === 'preview' && !clientEligible) content = '<article class="paper"><main class="memo"><div class="toast"><div class="kind verify">ТОЛЬКО ДЛЯ ВЛАДЕЛЬЦА</div><h1>Предпросмотр недоступен</h1><p>Клиент выбрал самооценку; публикация результата заблокирована.</p></div></main></article>';
  else if (mode === 'preview') content = '<article class="paper"><main class="memo"><div class="preview"><div class="kind fact">ТОЧНО ТАК УВИДИТ КЛИЕНТ</div><h2>Предпросмотр клиента</h2>' + renderClientPreview(o.client_draft, row) + (clientEligible && !['CLIENT_READY','CLIENT_NOTIFIED','CLIENT_VIEWED'].includes(String(row.review_status || '')) ? '<form method="post">' + authInputs(auth, 'approve') + '<div class="form-actions"><button class="btn gold" type="submit">Утвердить и сделать доступным</button></div></form>' : '') + '</div></main></article>';
