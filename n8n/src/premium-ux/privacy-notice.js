...
const FULL = {
  ru: {
    ...
    elements: {
      ...
      ai_processing: { heading: 'ИИ и Финансовая диагностика', body: 'Для ИИ используется минимизированная, псевдонимизированная проекция: прямые идентификаторы удаляются до обработки. Поскольку оператор может связать результат с обращением, эти данные не называются анонимными. Финансовая диагностика — предварительный управленческий анализ с проверкой человеком до публикации клиенту.' },
