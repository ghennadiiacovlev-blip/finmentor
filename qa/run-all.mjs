...
const GATES = [
  ...
  ['C4.11 Privacy & Data Governance v1', 'privacy-data-governance.test.mjs'],
  ['Privacy release gate (consent gating + no PII in analytics)', 'privacy-release-gate.test.mjs'],
  ['RO first contact (Romanian ack, no Russian menu)', 'ro-first-contact.test.mjs'],
  ...
  ['Premium UX result screen golden render (2026-09-04)', 'premium-ux-result-render.test.mjs'],
  ['Owner cards golden render (Lead Alerts, 2026-09-04)', 'owner-cards-golden.test.mjs'],
  ...
  ['C3 final closure — owner intelligence and callback integrity', 'c3-final-closure.test.mjs'],
