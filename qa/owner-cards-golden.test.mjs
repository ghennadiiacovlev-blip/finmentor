...
const GOLDEN = {
  'new RU lead (HOT)': [
    ...
    '',
    '<b>Alfa Grup SRL</b>',
    'Финансовый директор · Источник: Финансовая диагностика — расширенная анкета',
    '',
  ...
  'malicious HTML': [
    ...
    'CFO &lt;i&gt;&amp;&lt;/i&gt; · Источник: Финансовая диагностика — краткая анкета',
    '',
    '<b>Приоритет:</b> 🔥 Высокий приоритет',
  ...
  'missing optional fields': [
    ...
    '',
    '<b>Nord</b>',
    'Источник: Финансовая диагностика — расширенная анкета',
    '',
    '<b>Приоритет:</b> 🔥 Высокий приоритет',
    '',
    '<b>Запрос</b>',
